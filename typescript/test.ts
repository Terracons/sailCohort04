...
const inputText = document.querySelector("#inputElement") as HTMLInputElement
const inputText2 = document.querySelector("#inputElement2") as HTMLInputElement

const formButton = document.querySelector("#submitButton") as HTMLButtonElement
